...
//    uint16_t    pad;            // some Arduino black magic here
    ...
    public:
        ...
        uint16_t    Make_getACUInfoMsgResp(uint16_t, uint8_t*, uint16_t, uint16_t, uint32_t, uint32_t, uint32_t, uint32_t, uint16_t);
        void        Parse_getACUInfoMsgResp(uint8_t*, uint16_t*, uint32_t*, uint32_t*, uint32_t*, uint32_t*, uint16_t*);
