...
+xx.x[CR] or -xx.x[CR]
*/
bool  polySci::ReadSetPointTemperature(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
+xx.x[CR] or -xx.x[CR]]
*/
bool  polySci::ReadTemperature(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
C[CR] or F[CR]
*/
bool  polySci::ReadTemperatureUnits(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
1[CR] or 0[CR]
*/
bool  polySci::ReadStatus(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
xxx.x[CR]
*/
bool  polySci::ReadCompressorDischargeTemperature(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
Faults
*/
bool  polySci::ReadFaultStatus(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
xxx.x[CR]
*/
bool  polySci::ReadEvaporatorInletTemperature(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
xxx.x[CR]
*/
bool  polySci::ReadEvaporatorOutletTemperature(char** ppRetStr)
{
    // build command
    uint8_t count   = 0;
    bool retVal     = false;
...
bool polySci::ChillerPresent(char** ppRetStr)
{
    bool    retVal    = false;
    char*   pRetStr   = (ppRetStr ? 0 : *ppRetStr);
