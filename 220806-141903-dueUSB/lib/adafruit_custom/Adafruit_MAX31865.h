...
public:
  ...
  uint16_t readRTD_dd(void);  // deftDevise
  void clearOneShot_dd(void); // deftDevise
  void setOneShot_dd(void);   // deftDevise
  ...
  float temperature_dd(float RTDnominal, float refResistor);
