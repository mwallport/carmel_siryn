...
int main(int argc, char** argv)
{
  ...
  readPVPVOF  r;
  length = r.buildCmd(buff, len, dataCnt, id);
  ...
  cmdResp resp = s.buildResp(rx_buff, len, 0x0226, id);
  ...
  cmdResp resp2 = r.buildResp(rx_buff, len, 6, id);
